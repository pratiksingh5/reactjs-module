    ...
    <div className="w-full max-w-xl">
      <div className="bg-white rounded-3xl shadow-lg border border-neutral-200 p-6 md:p-8">
        ...
        <div className="mt-6">
          <div className="rounded-2xl bg-neutral-50 border border-neutral-200 p-5">
            ...
            {/* Quote text */}
              ...
              <blockquote
                className="text-neutral-800 text-lg md:text-xl leading-relaxed"
              >
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-3">
          <button
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl px-4 py-2.5 text-sm font-medium border border-neutral-200 bg-neutral-900 text-white hover:bg-neutral-800 active:scale-[.99] transition"
          >
            {/* small sparkle icon */}
            <svg width="16" height="16" viewBox="0 0 24 24" className="shrink-0" fill="currentColor" aria-hidden="true">
          ...
          <button
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl px-4 py-2.5 text-sm font-medium border border-neutral-200 bg-white text-neutral-900 hover:bg-neutral-100 active:scale-[.99] transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {/* copy icon */}
            <svg width="16" height="16" viewBox="0 0 24 24" className="shrink-0" fill="currentColor" aria-hidden="true">
